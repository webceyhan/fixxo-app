...
<template>
  <Menu as="div" class="relative inline-block text-left">
    ...
    >
      <MenuItems
        class="z-50 absolute mt-2 w-56 divide-y dark:divide-gray-900 rounded-md bg-white dark:bg-gray-800 shadow-lg ring-1 ring-black dark:ring-gray-500 ring-opacity-5 focus:outline-none"
        :class="{
