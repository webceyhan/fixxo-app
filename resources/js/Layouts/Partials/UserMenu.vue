    ...
    <template #trigger>
      ...
      >
        <div class="hidden sm:flex flex-col text-end">
          <span class="leading-5 font-medium">{{ user?.name }}</span>
          <small class="text-sm text-gray-500">{{ user?.role ?? "Expert" }}</small>
        </div>

        <Avatar
          class="!w-14 !h-14 ring-4 ring-indigo-200 dark:ring-indigo-900"
